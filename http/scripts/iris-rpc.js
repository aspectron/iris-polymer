/*<script src="/IRIS/scripts/math.uuid.js"></script>
<script src="/socket.io/socket.io.js"></script>*/

(function(){
    function dpc(t,fn) { if(typeof(t) == 'function') setTimeout(t,0); else setTimeout(fn,t); }
    window.IRIS = window.IRIS || {};
    window.IRIS.RPC  = IRIS_RPC;
    function IRIS_RPC(options){
        this.options = $.extend(this.options, options || {})
        this.init();
    }

    $.extend( IRIS_RPC.prototype, {
        online : false,
        timeout : 30,
        options:{
            path:'/rpc'
        ...
        connect: function(){
            ...
            self.socket = io(window.location.origin+self.options.path);
